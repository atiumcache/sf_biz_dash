...
describe('BusinessCollection', () => {
  ...
  describe('data transformation', () => {
    ...
    it('should handle optional fields correctly', () => {
      const businessWithMailing = businessCollection.findById(
        '1247900-03-201-1112531',
      );
      ...
      const businessWithoutMailing = businessCollection.findById(
        '1038156-08-151-1017634',
      );
    ...
    it('should parse dates correctly', () => {
      ...
      expect(business?.dates.dbaStart).toEqual(
        new Date('2015-08-24T00:00:00.000'),
      );
      expect(business?.dates.dbaEnd).toEqual(
        new Date('2016-05-05T00:00:00.000'),
      );
    });
  });
  ...
  describe('geographic queries', () => {
    ...
    it('should return empty array when radius is too small', () => {
      const nearby = businessCollection.getBusinessesInRadius(
        37.78,
        -122.4,
        0.001,
      );
